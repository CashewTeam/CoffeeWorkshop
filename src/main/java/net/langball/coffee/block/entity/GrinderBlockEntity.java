...
/**
 * Grinder block entity — grinds coffee beans into powder, wheat into
 * flour, etc.
 *
 * <p>Uses vanilla furnace fuels.  Extends
 * {@link AbstractFueledProcessingBlockEntity} which provides the shared
 * fuel + processing state machine.
 */
public class GrinderBlockEntity extends AbstractFueledProcessingBlockEntity {
    ...
    // ---- AbstractProcessingBlockEntity contract ---------------------------
    ...
    // ---- AbstractFueledProcessingBlockEntity contract --------------------
