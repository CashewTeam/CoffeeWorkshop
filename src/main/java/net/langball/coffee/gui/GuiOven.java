...
public class GuiOven extends AbstractContainerScreen<ContainerOven> {
    // Oven reuses the roller texture (same as 1.12.2 original)
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(CoffeeWork.MODID, "textures/gui/roller.png");

    public GuiOven(ContainerOven menu, Inventory inv, Component title) {
