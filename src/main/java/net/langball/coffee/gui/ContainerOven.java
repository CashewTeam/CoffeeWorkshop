...
public class ContainerOven extends AbstractMachineMenu {

    /** Client-side constructor. */
    public ContainerOven(int id, Inventory inv, BlockPos pos) {
        this(id, inv,
    ...
    public ContainerOven(int id, Inventory inv, IItemHandler handler, ContainerData data, MachineBlockEntity be) {
        super(ModMenuTypes.OVEN.get(), id, inv, handler, data, be, 3);
    }

    @Override
    protected void addMachineSlots() {
        this.addSlot(new SlotItemHandler(itemHandler, OvenBlockEntity.SLOT_INPUT, 56, 17));
        this.addSlot(new SlotItemHandler(itemHandler, OvenBlockEntity.SLOT_FUEL, 56, 53));
        this.addSlot(new SlotMachineResult(itemHandler, OvenBlockEntity.SLOT_OUTPUT, 116, 35,
                blockEntity, level));
    }
    ...
    protected Set<Block> getValidBlocks() {
        return Set.of(ModBlocks.OVEN.get());
    }

    @Override
    protected int getOutputSlotIndex() {
        return OvenBlockEntity.SLOT_OUTPUT;
    }
