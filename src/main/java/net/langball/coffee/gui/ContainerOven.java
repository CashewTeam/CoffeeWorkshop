...
public class ContainerOven extends AbstractContainerMenu {
    ...
    public ContainerOven(int id, Inventory inv, IItemHandler handler, ContainerData data, BlockEntity be) {
        ...
        // Oven reuses SlotGrinderOutput (same read-only behaviour, mirroring 1.12.2 original)
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (index == 2) {
                ...
                if (hasRecipe(itemstack1, ModRecipeTypes.OVEN_BAKING)) {
