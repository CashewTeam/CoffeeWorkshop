...
public class ContainerGrinder extends AbstractContainerMenu {
    ...
    public ContainerGrinder(int id, Inventory inv, IItemHandler handler, ContainerData data, BlockEntity be) {
        super(ModMenuTypes.GRINDER.get(), id);
    ...
    /**
     * Checks whether the given stack is a valid input for the grinder's recipe type.
     * Used by {@link #quickMoveStack(Player, int)} for auto-fill logic.
     */
    ...
    /** Resolves an IItemHandler from the BlockEntity at the given position, or returns an empty handler. */
